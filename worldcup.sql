...
--
-- Name: games fk_winne_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_winne_id FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
